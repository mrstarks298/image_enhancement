    ...
    if os.path.exists(filepath):  # Check if the file exists
        ...
        if operation == 'rotate':
            ...
            if rotated_image_path:
                image_path = url_for('static', filename='uploads/' + os.path.basename(rotated_image_path))
            ...
            if cropped_image_path:
                image_path = url_for('static', filename='uploads/' + os.path.basename(cropped_image_path))
            ...
            if blurred_image_path:
                image_path = url_for('static', filename='uploads/' + os.path.basename(blurred_image_path))
            ...
            if text_image_path:
                image_path = url_for('static', filename='uploads/' + os.path.basename(text_image_path))
